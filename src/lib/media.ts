...
export const montage: { image: string; caption: string }[] = [
  { image: media.trackLane, caption: "one of those days" },
  { image: media.runnerBlur, caption: "you + your impossible goals" },
  { image: media.delhiEnergy, caption: "another race" },
  { image: media.mountainLonavla, caption: "another story" },
  { image: media.cityLights, caption: "still you" },
];
